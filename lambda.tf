...
# #   #例）kdg-aws-2025-ここに自分のgithubのユーザー名とかにする
# #   bucket = "kdg-aws-2025-kuwayama-lambda-artifacts"  
  
# #   force_destroy = true
# #   tags = {
# #     Name = "kdg-aws-2025-kuwayama-lambda-artifacts"
# #   }
# # }

# #lambda を実行するときにそのlambda 関数が実行可能な権限をまとめるためのロールを定義
...
# # CloudWatch Logsへの書き込み権限を定義したroleに対して付与
